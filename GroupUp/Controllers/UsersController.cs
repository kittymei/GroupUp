...
namespace GroupUp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(GroupUpContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Password,FirstName,LastName,Gender,Dob,Email,StreetAddress,City,Country,ZipCode,Phone")] Users users)
        {
            if (id != users.Id)
            {
                return NotFound();
