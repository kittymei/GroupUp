...
namespace GroupUp.Controllers
{
    public class RequestsController : Controller
    {
        ...
        public RequestsController(GroupUpContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Subject,Topic,SchoolType,Experience,StudyDate,AddressLine1,AddressLine2,City,State,Country,ZipCode")] Request request)
        {
            if (id != request.Id)
            {
                return NotFound();
